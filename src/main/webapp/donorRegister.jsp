			...
			<div class="col-md-6 offset-md-3">
				<div class="card card-sh">
					<div class="card-header">
						<p class="text-center fs-3">Donor Registration</p>
					...
					<div class="card-body">
						<form action="donorRegister" method="post">
							<div class="mb-3">
								<label class="required-label">Donor Name</label> <input type="text" name="name"
									class="form-control" required>
							</div>
							<div class="mb-3">
								<label class="required-label">Age</label> <input type="text" name="age"
									class="form-control" required>
							</div>
							<div class="mb-3">
							...
							<div class="mb-3">
								...
								<br> <select id="district" name="district" class="form-control" disabled required>
							...
							<div class="mb-3">
								<label>Addresss</label> <input type="text" name="address"
									class="form-control">
							</div>
							<div class="mb-3">
