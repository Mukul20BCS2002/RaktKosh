			...
			<div class="col-md-6 offset-md-3">
				<div class="card card-sh">
					<div class="card-header">
						<p class="text-center fs-3">Thalassemia Patient Login</p>
					...
					<div class="card-body">
						<form action="thalassemiaLogin" method="post">
							<div class="mb-3">
							...
							New Registration <a href="thalassemiaRegister.jsp">Create one</a>
							</div>
						</form>
					</div>
				</div>
